...
import { ConceptualEntity , ConceptualAssociation, ConceptualCharacteristic, ConceptualParticipant, ConceptualBasisEntity, DataModel, isConceptualEntity, ConceptualComposableElement} from "../../generated/ast";
...
*/
export const getEntityIdentity = (model: ConceptualEntity): (string |
    {
        type: ConceptualComposableElement | undefined;
 ...
 * UDDL/com.epistimis.uddl/src/com/epistimis/uddl/constraints//conditional_entityIsUnique.ocl
